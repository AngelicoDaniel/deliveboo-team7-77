...
@section('content')
    <form action="{{ route('admin.dishes.update', $dish->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row mt-3">
            ...
            <div class="col-md-6">
                <input id="price" type="number" min="0.1" step=".01"
                    ...
                    required autocomplete="price" placeholder="10.00">
                @error('price')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="form-group row">
            <label for="image" class="col-md-4 col-form-label text-md-right">{{ __('Immagine ristorante') }}
        ...
        <div class="form-group row">
            <label for="visibility" class="col-md-4 col-form-label text-md-right">{{ __('Visibile') }}
                <span class="text-success">*</span></label>
            <div class="col-md-6">
                <select class="form-control" name="visibility" required autocomplete="visibility">
